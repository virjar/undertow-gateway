...
public class UndertowWebServer implements WebServer {
    ...
    private List<Port> getActualPorts() {
        ...
        try {
            if (!this.autoStart) {
                ...
                for (Channel channel : extractChannels()) {
    ...
    private List<Channel> extractChannels() {
        Field channelsField = ReflectionUtils.findField(Undertow.class, "channels");
        ReflectionUtils.makeAccessible(channelsField);
        return (List<Channel>) ReflectionUtils.getField(channelsField, this.undertow);
    }

    private UndertowWebServer.Port getPortFromChannel(Channel channel) {
