...
public class UndertowOptions {
     ...
     */
    public static final Option<Integer> MAX_HEADER_SIZE = UndertowOption.create("MAX_HEADER_SIZE", Integer.class);
    /**
     ...
     */
    public static final Option<Long> MAX_ENTITY_SIZE = UndertowOption.create("MAX_ENTITY_SIZE", Long.class);
     ...
     */
    public static final Option<Integer> NO_REQUEST_TIMEOUT = UndertowOption.create("NO_REQUEST_TIMEOUT", Integer.class);
     ...
     * Defaults to 1000
     */
    public static final Option<Integer> MAX_PARAMETERS = UndertowOption.create("MAX_PARAMETERS", Integer.class);
     ...
     * Defaults to 200
     */
    public static final Option<Integer> MAX_HEADERS = UndertowOption.create("MAX_HEADERS", Integer.class);
     ...
     * Defaults to 200
     */
    public static final Option<Integer> MAX_COOKIES = UndertowOption.create("MAX_COOKIES", Integer.class);
     ...
     */
    public static final Option<Boolean> ALLOW_ENCODED_SLASH = UndertowOption.create("ALLOW_ENCODED_SLASH", Boolean.class);
     ...
     * See <a href="http://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2007-0450">CVE-2007-0450</a>
     */
    public static final Option<Boolean> DECODE_SLASH = UndertowOption.create("DECODE_SLASH", Boolean.class);
     ...
     * Defaults to true.
     */
    public static final Option<Boolean> DECODE_URL = UndertowOption.create("DECODE_URL", Boolean.class);
     ...
     * Defaults to true.
     */
    public static final Option<String> URL_CHARSET = UndertowOption.create("URL_CHARSET", String.class);
     ...
     * Defaults to true
     */
    public static final Option<Boolean> ALWAYS_SET_KEEP_ALIVE = UndertowOption.create("ALWAYS_SET_KEEP_ALIVE", Boolean.class);
