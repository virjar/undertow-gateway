...
//    ClosedChannelException channelIsClosed();
    ...
    IllegalStateException moreThanOnePredicateWithName(String name, Class<?> aClass, Class<?> existing);
    ...
    IllegalStateException moreThanOneHandlerWithName(String name, Class<?> aClass, Class<?> existing);
//
